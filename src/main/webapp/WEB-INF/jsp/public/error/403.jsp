...
<head>
    <title>FQED 403 - Access Denied</title>
...
<div class="container" >
    ...
    <script>
        $(function () {
            $("#banner").load("../static/assets/bannerL2.html");/*
    ...
    <div class="row">
        <div class="col-12" id="main" style="padding-top: 27%; background-repeat:no-repeat; width: 100%;">
            <div  id="column-content"> <strong>Error 403</strong> &nbsp;<span style="font-size: .6em;
	vertical-align: middle;">Access Denied</span> </div>
        </div>
    </div>
    <div class="row">
        <div class="col-2"></div>
        <div class="col-lg-9" style="padding-top: 2em; height: 35vh">
            <h5>
                You do not have permission to view this resource.</div>
        <div class="col-2"> </div>
    </div>
</div>
</div>
