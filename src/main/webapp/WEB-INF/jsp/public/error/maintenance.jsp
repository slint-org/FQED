...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="sub-header">
            <span>Sorry, this page is currently under maintenance. We are working to have this resolved as soon as possible!</span>
        </div>
        <%--<div class="social-media">--%>
            ...
            <%--<div class="social-space col-md-4 col-sm-12">--%>
                ...
                <%--<a href="https://www.linkedin.com/company/fqed/" target="_blank" class="fa fa-linkedin"></a>--%>
